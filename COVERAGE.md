...
| dreamy-minimal | 1 | 1 | 2 | - | 1 | - | - |
| nightflame-minimal | 1 | 1 | 1 | 1 | 1 | - | - |
...
- **task.acknowledge** (1): Cancel (low)
- **task.complete** (1): Confirm
- **task.error** (1): Cancel
...
- **task.complete** (2): Soft dreamy beep, Positive blip
- **task.error**: MISSING
- **input.required** (1): Menu beep
- **resource.limit**: MISSING
- **user.spam**: MISSING

### nightflame-minimal

- **session.start** (1): Session sweep
- **task.acknowledge** (1): Ascending tone
- **task.complete** (1): Confirmation tone
- **task.error** (1): Descending tone
- **input.required** (1): Attention whoosh
- **resource.limit**: MISSING
- **user.spam**: MISSING
